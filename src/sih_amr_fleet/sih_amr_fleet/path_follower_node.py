...
from sih_amr_interfaces.msg import RobotState, RoutePlan
...
class PathFollowerNode(Node):
    ...
    def __init__(self):
        ...
        self.pose, self.route, self.clear = None, None, True
    ...
    def control(self):
        cmd = Twist()
        if self.pose is not None and self.route and len(self.route.waypoints) > 1 and self.clear:
